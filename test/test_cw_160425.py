...
#     inventory_list = driver.find_elements(By.CLASS_NAME, "inventory_list")
...
#     user_name_input_field.send_keys("standard_user")
#     password_input_field = driver.find_element(By.ID, "password")
#     password_input_field.send_keys("invalid_secret_sauce")
#     login_button = driver.find_element(By.ID, "login-button")
#     login_button.click()
#     error_message = driver.find_element(By.CLASS_NAME, 'error-message-container')
#     assert "Epic sadface: Username and password do not match any user in this service" in error_message.text, "Test не прошел"
#
